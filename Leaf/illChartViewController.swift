...
class illChartViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let xModel = ChartAxisModel(axisValues: xValues, axisTitleLabel: ChartAxisLabel(text: "你好", settings: labelSettings))
        let yModel = ChartAxisModel(axisValues: yValues, axisTitleLabel: ChartAxisLabel(text: "你好", settings: labelSettings.defaultVertical()))
